...
def make_request_auth(username, password):
    ...
    return response
@pytest.mark.parametrize("user_cred",read_credentials_from_excel("/Users/apple/PycharmProjects/Py1xApiAutomation/tests/data_driven_testing/testdata_ddt.xlsx"))
